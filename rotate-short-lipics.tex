...
\begin{document}
  ...
  \supplementdetails[subcategory={Archived Source}]{Text}{https://doi.org/10.5281/zenodo.18750353}
  ...
  Alongside the Dolphin algorithm, Griess--Mills~\cite{GriesMills81}
  discuss two alternative schemes: one may implement a rotation as a
  ...
  ``typical'' $k$. Despite using more moves, both alternatives are better
  suited to modern machines due to superior memory access patterns vastly
...
%  \end{remark}
  ...
  Lemma~\ref{lemma.moves} relates the move count to the sum of remainders
...
%    \end{align*}
 ...
 %   \cite[{p.\ 509, last display with $k=3$}]{MR1341859}. Thus, we find
  ...
  code can be found on Github: \url{https://github.com/k-u-bux/rotate-paper}
